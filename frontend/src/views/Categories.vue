  ...
  <div>
    ...
    <div class="category-tabs">
      <button
        ...
        @click="activeCategory = cat.code; page = 1; fetchDocs()"
      >
        {{ cat.label }}
      </button>
      <button
        ...
        @click="activeCategory = 'uncategorized'; page = 1; fetchDocs()"
      >
        未分类
      </button>
    </div>
...
import { getDocuments, toggleFavorite, setCategory } from '../api'
...
const categories = [
  { code: 'sujian', label: '素笺' },
  { code: 'shicui', label: '拾萃' },
  { code: 'manbi', label: '漫笔' }
]

const activeCategory = ref('sujian')
